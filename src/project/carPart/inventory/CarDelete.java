...
/**
 * This class is in charge to do SQL deletions.
 */
public class CarDelete {
    ...
    public static ArrayList<String> getInfo(Connection con, String attr,
        ...
        if (!where)
            CarDeletePanel.cmbCarModel.removeAllItems();

        CarDeletePanel.cmbCarYear.removeAllItems();
        ResultSet rs = null;
        String stmntStr = "";
        if (!where)
    ...
    public static void getCarInfo(Connection con, String model, String year,
        ...
        try {
            ...
            System.out.println("\nHere is more info about the car you have"
                    ...
                    + CarDeletePanel.carMakers[index] + "\nModel: " + model
                    + "\nYear: " + year);
        ...
        des += "\n";
        CarDeletePanel.txtDisplay.setText(des);
        // return rlink;
    }// Method
    ...
    public static String deleteCar(Connection con, String model, String year,
            String table, String desc, String ltr, String eng, String CID,
            String rl) {
        String stmntStr = "";
        stmntStr = "DELETE FROM " + table + " WHERE MODEL = '" + model
                + "' AND YEAR = " + year + " AND DESCRIPTION = '" + desc
                + "' AND Litres = '" + ltr + "' AND Engine_type = '" + eng
                + "' AND CUBIC_INCHES = '" + CID + "' AND Rlink = '" + rl + "'";
